...
png(filename="plot3.png",width=480, height=480, units="px") # setting up the graphics device
# making the plot
...
legend("topright", legend=colnames(power_data[,7:9]), col=c("black", "red","blue"), lty=1)
